	...
	corelogic =
	{
		...
		[0] =
		{
			logic_auto =
			{
				...
				"OnMapSpawn#25" : "tf_objective_resource,$SetClientProp$m_iszMvMPopfileName,Bauernhof Der Toten,0,-1",
		...
		[7] =
		{
			logic_relay =
			{
				...
				"OnTrigger#6" : "tf_objective_resource,$SetClientProp$m_nMannVsMachineWaveCount,0,,-1",
			},
		},
		[8] =
		{
		...
		[9] =
		{
			logic_compare =
			{
				...
				initialValue = 0,
				CompareValue = 4,
				"OnEqualTo#1" : "player,$AddCurrency,1500,,-1",
				"OnEqualTo#2" : "player,$DisplayTextCenter,You've received a 1500 Survival Bonus!,,-1",
		...
		[13] =
		{
			func_flagdetectionzone =
			{
				...
				"OnStartTouchFlag#11" : "!activator,$DisplayTextChat,Tavish has given you his Super Shank!,6.5,-1",
	...
	Spawn_things =
	{
		...
		[26] =
		{
			logic_relay =
			{
				...
				"OnTrigger#16" : "player,$PlaySoundToSelf,shadows/announcer_bossround.mp3,7,-1",
		...
		[27] =
		{
			logic_relay =
			{
				...
				"OnTrigger#14" : "navman,RecomputeBlockers,,3,-1",
				"OnTrigger#15" : "navman,RecomputeBlockers,,4,-1",
				"OnTrigger#16" : "player,$PlaySoundToSelf,shadows/announcer_chuckle.mp3,7,-1",
			},
		},
		[28] =
		{
			logic_relay =
			{
				...
				"OnTrigger#1" : "player,$PlaySoundToSelf,#*shadows/bossround_end.mp3,0,-1",
				"OnTrigger#2" : "relay_enemycount_reset,Trigger,,-1,-1",
				"OnTrigger#3" : "medicbonus_relay,Trigger,,-1,-1",
				"OnTrigger#4" : "respawner,ForceTeamRespawn,2,0.7,-1",
		...
		[29] =
		{
			logic_branch =
			{
				...
				"OnFalse#4" : "!activator,$DisplayTextChat,You've received an Ãœberweapon: The Thunder Gun!,0,-1",
				...
				"OnTrue#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
			},
		},
		[30] =
		{
	...
	Plate_Big =
	{
		...
		[5] =
		{
			trigger_add_tf_player_condition =
			{
				...
				"OnStartTouchAll#8" : "powerup_timer,Enable,,-1,-1",
				"OnStartTouchAll#9" : "plate,skin,0,-1,-1",
				"OnStartTouchAll#10" : "!activator,$AddCurrency,400,3,-1",
			},
		},
		[6] =
		{
		...
		[8] =
		{
			trigger_add_tf_player_condition =
			{
				...
				"OnStartTouchAll#4" : "!activator,$DisplayTextCenter,Instakill!,0,-1",
				...
				"OnStartTouchAll#7" : "!activator,$AddPlayerAttribute,dmg current health|1,,-1",
				"OnStartTouchAll#8" : "!activator,$AddCond,56,,-1",
				"OnStartTouchAll#9" : "!activator,$RemovePlayerAttribute,dmg current health,30,-1",
				"OnStartTouchAll#10" : "!activator,$RemoveCond,56,30,-1",
			},
		},
		[9] =
		{
		...
		[10] =
		{
			trigger_add_tf_player_condition =
			{
				...
				"OnStartTouchAll#2" : "powerup_timer,Enable,,-1,-1",
				"OnStartTouchAll#3" : "plate,skin,0,-1,-1",
				"OnStartTouchAll#4" : "!activator,$DisplayTextCenter,Max Ammo!,0,-1",
				...
				"OnStartTouchAll#7" : "!activator,$RefillAmmo,,-1,-1",
			},
		},
		[11] =
		{
		...
		[12] =
		{
			trigger_add_tf_player_condition =
			{
				...
				"OnStartTouchAll#2" : "powerup_timer,Enable,,-1,-1",
				"OnStartTouchAll#3" : "plate,skin,0,-1,-1",
				"OnStartTouchAll#4" : "!activator,$DisplayTextCenter,Bonus Points!,0,-1",
				"OnStartTouchAll#5" : "!activator,$PlaySoundToSelf,items/powerup_pickup_agility.wav,0,-1",
				"OnStartTouchAll#6" : "!activator,$PlaySoundToSelf,shadows/powerup_money_01.mp3,1,-1",
				"OnStartTouchAll#7" : "!activator,$AddCurrency,2000,-1,-1",
			},
		},
		[13] =
		{
	...
	Revivemarker =
	{
		[0] =
		{
			trigger_multiple =
			{
				...
				maxs = "36 36 36",
				spawnflags = 1,
				"OnStartTouch#1" : "!activator,$DisplayTextCenter,Hold Action key to revive your teammate,0,-1",
			},
		},
		[1] =
		{
	...
	Vending_Jugg =
	{
		...
		[6] =
		{
			trigger_multiple =
			{
				...
				mins = "-128 -128 0",
				maxs = "128 128 128",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to buy Saxton Ale for $2500,0,-1",
			},
		},
		[7] =
		{
		...
		[8] =
		{
			logic_relay =
			{
				...
				"OnTrigger#4" : "!activator,$AddPlayerAttribute,max health additive bonus|150,2.2,-1",
				"OnTrigger#5" : "!activator,$PlaySoundToSelf,weapons/buffed_on.wav,2.2,-1",
				"OnTrigger#6" : "!activator,$DisplayTextCenter,Perk Bonus activated: Extra max health!,2.2,-1",
	...
	Vending_Speed =
	{
		...
		[5] =
		{
			trigger_multiple =
			{
				...
				mins = "-128 -128 0",
				maxs = "64 64 128",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to buy Meraslixir for $3000,0,-1",
			},
		},
		[6] =
		{
		...
		[7] =
		{
			logic_relay =
			{
				...
				"OnTrigger#4" : "!activator,$AddPlayerAttribute,faster reload rate|0.5,2.2,-1",
				"OnTrigger#5" : "!activator,$AddPlayerAttribute,move speed bonus|1.15,2.2,-1",
				"OnTrigger#6" : "!activator,$PlaySoundToSelf,weapons/buffed_on.wav,2.2,-1",
				"OnTrigger#7" : "!activator,$DisplayTextCenter,Perk Bonus activated: Increased movement and reload speed!,2.2,-1",
	...
	Vending_Blaster =
	{
		...
		[4] =
		{
			trigger_multiple =
			{
				...
				mins = "-128 -128 0",
				maxs = "128 128 128",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to buy Head Rattle for $1500,0,-1",
			},
		},
		[5] =
		{
		...
		[6] =
		{
			logic_relay =
			{
				...
				"OnTrigger#4" : "!activator,$AddPlayerAttribute,explosive sniper shot|2,2.2,-1",
				"OnTrigger#5" : "!activator,$PlaySoundToSelf,weapons/buffed_on.wav,2.2,-1",
				"OnTrigger#6" : "!activator,$DisplayTextCenter,Perk Bonus activated: Explosive Headshot!,2.2,-1",
				"OnTrigger#7" : "!activator,SpeakResponseConcept,TLK_PLAYER_SPELL_PICKUP_RARE,2.45,-1",
			},
		},
	},
	Vending_Doubletap =
	{
		...
		[5] =
		{
			trigger_multiple =
			{
				...
				mins = "-128 -128 0",
				maxs = "128 128 128",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to buy Double Tap for $2000,0,-1",
			},
		},
		[6] =
		{
		...
		[7] =
		{
			logic_relay =
			{
				...
				"OnTrigger#4" : "!activator,$AddPlayerAttribute,mult_item_meter_charge_rate|0.67,-1,-1",
				"OnTrigger#5" : "!activator,$AddPlayerAttribute,fire rate bonus|0.67,-1,-1",
				"OnTrigger#6" : "!activator,$PlaySoundToSelf,weapons/buffed_on.wav,2.2,-1",
				"OnTrigger#7" : "!activator,$DisplayTextCenter,Perk Bonus activated: Increased fire rate!,2.2,-1",
				"OnTrigger#8" : "!activator,SpeakResponseConcept,TLK_PLAYER_SPELL_PICKUP_RARE,2.45,-1",
			},
		},
	},
	Vending_Quickrevive =
	{
		...
		[6] =
		{
			trigger_multiple =
			{
				...
				mins = "-128 -128 0",
				maxs = "128 128 128",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to buy Ostarion's Reserve for $1500,0,-1",
			},
		},
		[7] =
		{
		...
		[8] =
		{
			logic_relay =
			{
				...
				"OnTrigger#5" : "!activator,$AddCond,70,-1,-1",
				"OnTrigger#6" : "!activator,$AddCond,129,-1,-1",
				"OnTrigger#7" : "!activator,$PlaySoundToSelf,weapons/buffed_on.wav,2.2,-1",
				"OnTrigger#8" : "!activator,$DisplayTextCenter,Perk Bonus activated: Survive one fatal attack!,2.2,-1",
	...
	Roundtimer =
	{
		...
		[4] =
		{
			math_counter =
			{
				...
				max = 255,
				"outvalue#1" : "roundformat,$setkey$case01,,0,-1",
				"OutValue#1" : "tf_objective_resource,$SetClientProp$m_nMannVsMachineWaveCount,,0,-1",
				"outvalue#2" : "gameoverformat,$setkey$case01,,0,-1",
			},
		},
		[5] =
		{
			math_counter =
			{
				...
				min = 0,
				max = 26,
				"outvalue#1" : "enemyformat,$setkey$case01,,0,-1",
			},
		},
		[6] =
		{
			logic_case =
			{
				...
				"ondefault#1" : "enemytext,$setkey$message,,0,-1",
	...
	NukeDrop =
	{
		...
		[4] =
		{
			trigger_multiple =
			{
				...
				"OnStartTouchAll#11" : "!activator,$AddCurrency,400,3,-1",
			},
		},
		[5] =
		{
	...
	DumpsterBox =
	{
		...
		[6] =
		{
			trigger_multiple =
			{
				...
				mins = "-64 -64 -64",
				maxs = "96 96 96",
				"OnStartTouchAll#1" : "!activator,$DisplayTextCenter,Hold Action key to receive a weapon for $950,0,-1",
			},
		},
		[7] =
		{
		...
		[8] =
		{
			logic_relay =
			{
				...
				"OnTrigger#4" : "player,$PlaySoundToSelf,shadows/powerup_dud_03.mp3,1,-1",
				"OnTrigger#5" : "dumpster_warp_eff,Start,,3,-1",
				"OnTrigger#6" : "dumpster_warp_beam,Stop,,3,-1",
				"OnTrigger#7" : "player,$PlaySoundToSelf,misc/halloween/merasmus_disappear.wav,3,-1",
				...
				"OnTrigger#18" : "player,$PlaySoundToSelf,misc/halloween/merasmus_appear.wav,26,-1",
		...
		[23] =
		{
			func_button =
			{
				...
				"OnPressed#2" : "!activator,$RemoveCurrency,950,-1,-1",
		...
		[24] =
		{
			logic_case =
			{
				...
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The Shortstop!,0,-1",
				...
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The Shortstop!,0,-1",
				...
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				...
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				...
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Stickybomb Launcher!,0,-1",
				...
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Stickybomb Launcher!,0,-1",
				...
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Force-a-Nature!,0,-1",
				...
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Force-a-Nature!,0,-1",
				...
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Scattergun,0,-1",
				...
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Scattergun,0,-1",
				...
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
				...
				"OnCase12#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
				...
				"OnCase13#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
		...
		[25] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SHOTGUN_PYRO,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase03#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SCATTERGUN,-1,-1",
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The Scattergun,0,-1",
				"OnCase04#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SCATTERGUN,-1,-1",
				"OnCase04#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase04#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The Scattergun,0,-1",
				"OnCase05#1" : "!activator,$AwardAndGiveExtraItem,Double Barrel,-1,-1",
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,Double Barrel,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_PIPEBOMBLAUNCHER,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Stickybomb Launcher!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_PIPEBOMBLAUNCHER,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Stickybomb Launcher!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,The Crusader's Crossbow,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Crusader's Crossbow!,0,-1",
				"OnCase10#1" : "!activator,$AwardAndGiveExtraItem,The Crusader's Crossbow,-1,-1",
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Crusader's Crossbow!,0,-1",
				"OnCase11#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
				"OnCase12#1" : "!activator,$AwardAndGiveExtraItem,Beam Rifle,-1,-1",
				"OnCase12#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase12#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase12#4" : "!activator,$DisplayTextChat,You've received: The Beam Rifle!,0,-1",
				"OnCase13#1" : "!activator,$AwardAndGiveExtraItem,The Punch Packer,-1,-1",
				"OnCase13#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase13#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase13#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
				...
				"OnCase14#4" : "!activator,$DisplayTextChat,You've received: The Cleaner's Carbine!,0,-1",
		...
		[26] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,Double Barrel,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase03#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SMG,-1,-1",
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				...
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Rocket Launcher!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_ROCKETLAUNCHER,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Rocket Launcher!,0,-1",
				...
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
				...
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Tactigatling!,0,-1",
				...
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Beam Rifle!,0,-1",
				"OnCase10#1" : "!activator,$AwardAndGiveExtraItem,The Cleaner's Carbine,-1,-1",
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Cleaner's Carbine!,0,-1",
				...
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Cleaner's Carbine!,0,-1",
		...
		[27] =
		{
			logic_case =
			{
				...
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase04#1" : "!activator,$AwardAndGiveExtraItem,Double Barrel,-1,-1",
				"OnCase04#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase04#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				"OnCase05#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SMG,-1,-1",
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SMG,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_PIPEBOMBLAUNCHER,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Stickybomb Launcher!,0,-1",
				...
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Tactigatling!,0,-1",
				...
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Beam Rifle!,0,-1",
				"OnCase11#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
		...
		[28] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The Scattergun!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SCATTERGUN,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The Scattergun!,0,-1",
				"OnCase03#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_FLAMETHROWER,-1,-1",
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase04#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_FLAMETHROWER,-1,-1",
				"OnCase04#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase04#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase05#1" : "!activator,$AwardAndGiveExtraItem,The Punch Packer,-1,-1",
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,The Punch Packer,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,Primary SMG,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,Primary SMG,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,The Crusader's Crossbow,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Crusader's Crossbow!,0,-1",
				...
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Black Box!,0,-1",
				"OnCase12#1" : "!activator,$AwardAndGiveExtraItem,Das Maschinenpistole,-1,-1",
				"OnCase12#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase12#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase12#4" : "!activator,$DisplayTextChat,You've received: Das Maschinenpistole!,0,-1",
				"OnCase13#1" : "dumpster_dud,Trigger,-1,0,-1",
			},
		},
		[29] =
		{
			logic_case =
			{
				...
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_FLAMETHROWER,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_MINIGUN,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Minigun!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_MINIGUN,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Minigun!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
				"OnCase10#1" : "!activator,$AwardAndGiveExtraItem,Beam Rifle,-1,-1",
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Beam Rifle!,0,-1",
				...
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Tactigatling!,0,-1",
				"OnCase12#1" : "tgun_check,Test,,-1,-1",
				"OnCase13#1" : "dumpster_dud,Trigger,-1,0,-1",
			},
		},
		[30] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_FLAMETHROWER,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The Flamethrower!,0,-1",
				"OnCase03#1" : "!activator,$AwardAndGiveExtraItem,Double Barrel,-1,-1",
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The Double Barrel!,0,-1",
				...
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Dragon's Fury!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,The Dragon's Fury,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Dragon's Fury!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_MINIGUN,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Minigun!,0,-1",
				"OnCase10#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_MINIGUN,-1,-1",
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Minigun!,0,-1",
				"OnCase11#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
				...
				"OnCase12#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase12#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase12#4" : "!activator,$DisplayTextChat,You've received: The Tactigatling!,0,-1",
		...
		[31] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SMG,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				"OnCase03#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_PISTOL,-1,-1",
				"OnCase03#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase03#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase03#4" : "!activator,$DisplayTextChat,You've received: The Pistol!,0,-1",
				"OnCase04#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_PISTOL,-1,-1",
				"OnCase04#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase04#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The Pistol!,0,-1",
				"OnCase05#1" : "!activator,$AwardAndGiveExtraItem,Primary Ambassador,-1,-1",
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Ambassador!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,Primary Ambassador,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Ambassador!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,Big Iron,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Big Iron!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,Big Iron,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Big Iron!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SHOTGUN_PYRO,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase10#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SHOTGUN_PYRO,-1,-1",
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase11#1" : "!activator,$AwardAndGiveExtraItem,The Winger,-1,-1",
				"OnCase11#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase11#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase11#4" : "!activator,$DisplayTextChat,You've received: The Winger!,0,-1",
				...
				"OnCase12#4" : "!activator,$DisplayTextChat,You've received: The Winger!,0,-1",
				"OnCase13#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase13#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase13#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase13#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
		...
		[32] =
		{
			logic_case =
			{
				...
				"OnCase01#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase01#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase01#4" : "!activator,$DisplayTextChat,You've received: The B.M.M.H!,0,-1",
				"OnCase02#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SMG,-1,-1",
				"OnCase02#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase02#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase02#4" : "!activator,$DisplayTextChat,You've received: The SMG!,0,-1",
				...
				"OnCase04#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase04#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase04#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase05#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SCATTERGUN,-1,-1",
				"OnCase05#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase05#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase05#4" : "!activator,$DisplayTextChat,You've received: The Scattergun!,0,-1",
				"OnCase06#1" : "!activator,$AwardAndGiveExtraItem,TF_WEAPON_SHOTGUN_PRIMARY,-1,-1",
				"OnCase06#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase06#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase06#4" : "!activator,$DisplayTextChat,You've received: The Shotgun!,0,-1",
				"OnCase07#1" : "!activator,$AwardAndGiveExtraItem,The Nostromo Napalmer,-1,-1",
				"OnCase07#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase07#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase07#4" : "!activator,$DisplayTextChat,You've received: The Nostromo Napalmer!,0,-1",
				"OnCase08#1" : "!activator,$AwardAndGiveExtraItem,The Nostromo Napalmer,-1,-1",
				"OnCase08#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase08#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
				"OnCase08#4" : "!activator,$DisplayTextChat,You've received: The Nostromo Napalmer!,0,-1",
				"OnCase09#1" : "!activator,$AwardAndGiveExtraItem,The Ray Gun,-1,-1",
				"OnCase09#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase09#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase09#4" : "!activator,$DisplayTextChat,You've received: The Ray Gun!,0,-1",
				...
				"OnCase10#2" : "!activator,$PlaySoundToSelf,items/gunpickup2.wav,-1,-1",
				"OnCase10#3" : "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
				"OnCase10#4" : "!activator,$DisplayTextChat,You've received: The Punch Packer!,0,-1",
	...
	Camera_Crew_Death =
	{
		...
		[3] =
		{
			logic_case =
			{
				...
				"ondefault#1" : "gameovertext,$setkey$message,,0,-1",
		...
		[9] =
		{
			logic_relay =
			{
				...
				"OnTrigger#9" : "player,$DisplayTextCenter,Game over,3,-1",
		...
		[10] =
		{
			logic_relay =
			{
				...
				"OnTrigger#2" : "player,$DisplayTextCenter,Game over,0,-1",
