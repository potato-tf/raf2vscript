...
::DumpsterBox <- function(org, ang)
{
	...
	local logic_case324 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase01#1": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_handgun_scout_primary`,220,null)-1",
	    ...
	    "OnCase02#5": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_handgun_scout_primary`,220,null)-1",
	...
	local logic_case325 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase06#21": "!activatorRunScriptCodeGiveWeapon(self,`I`,-1,V)-1",
	    "OnCase06#22": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase06#23": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	    ...
	    "OnCase13#49": "!activatorRunScriptCodeGiveWeapon(self,`I`,-1,V)-1",
	    "OnCase13#50": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase13#51": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
	    "OnCase13#52": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The Punch Packer!`)0-1",
	    "OnCase14#53": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_charged_smg`,751,null)-1",
	...
	local logic_case326 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase07#25": "!activatorRunScriptCodeGiveWeapon(self,`I`,-1,V)-1",
	    "OnCase07#26": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    ...
	    "OnCase10#37": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_charged_smg`,751,null)-1",
	    "OnCase10#38": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase10#39": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	    "OnCase10#40": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The Cleaner's Carbine!`)0-1",
	    "OnCase11#41": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_charged_smg`,751,null)-1",
	    "OnCase11#42": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	...
	local logic_case327 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase10#37": "!activatorRunScriptCodeGiveWeapon(self,`I`,-1,V)-1",
	    "OnCase10#38": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	...
	local logic_case329 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase10#39": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
	    "OnCase10#40": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The Beam Rifle!`)0-1",
	    "OnCase11#41": "!activatorRunScriptCodeGiveWeapon(self,`I`,-1,V)-1",
	    "OnCase11#42": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase11#43": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_RARE,0.6,-1",
	...
	local logic_case330 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase06#23": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	    "OnCase06#24": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The SMG!`)0-1",
	    "OnCase07#25": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_rocketlauncher_fireball`,1178,null)-1",
	    "OnCase07#26": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase07#27": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	    "OnCase07#28": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The Dragon's Fury!`)0-1",
	    "OnCase08#29": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_rocketlauncher_fireball`,1178,null)-1",
	    "OnCase08#30": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase08#31": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	...
	local logic_case332 = SpawnEntityFromTable("logic_case", {
	    ...
	    "OnCase07#25": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_flamethrower`,30474,null)-1",
	    "OnCase07#26": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase07#27": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
	    "OnCase07#28": "!activatorRunScriptCodeClientPrint(self, 4, `You've received: The Nostromo Napalmer!`)0-1",
	    "OnCase08#29": "!activatorRunScriptCodeGiveWeapon(self,`tf_weapon_flamethrower`,30474,null)-1",
	    "OnCase08#30": "!activatorRunScriptCodeEmitSoundEx({sound_name = `items/gunpickup2.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })-1",
	    "OnCase08#31": "!activator,SpeakResponseConcept,TLK_MVM_LOOT_COMMON,0.6,-1",
...
{
	local trigger_hurt_brush136 = SpawnEntityFromTable("trigger_hurt", {
	    spawnflags = 1,
	...
	trigger_hurt_brush136.KeyValueFromInt("solid", 2)
	trigger_hurt_brush136.KeyValueFromString("mins", "-128 -128 -36")
	trigger_hurt_brush136.KeyValueFromString("maxs", "128 128 36")
...
corelogic(Vector(0, 0, 0), [0, 0, 0])
Spawn_things(Vector("320, -32, 32"), ["0, 270, 0"])
PlayersLeftLogic(Vector(0, 0, 0), [0, 0, 0])
PlayerTracker(Vector(0, 0, 0), [0, 0, 0])
EnemyTracker(Vector(0, 0, 0), [0, 0, 0])
Hulk_PT(Vector(0, 0, 0), [0, 0, 0])
Charger_PT(Vector(0, 0, 0), [0, 0, 0])
Soldier_Tank(Vector(0, 0, 0), [0, 0, 0])
Heavy_Boss(Vector(0, 0, 0), [0, 0, 0])
tutorial(Vector(0, 0, 0), [0, 0, 0])
DummyMachines(Vector("477, -2103, 4"), ["0, 270, 0"])
Vending_Jugg(Vector("0, 0, 50"), [0, 0, 0])
Vending_Speed(Vector("0, 0, 50"), [0, 0, 0])
Vending_Blaster(Vector("0, 0, 50"), [0, 0, 0])
Vending_Doubletap(Vector("0, 0, 50"), [0, 0, 0])
Vending_Quickrevive(Vector("0, 0, 50"), [0, 0, 0])
Vending_Flop(Vector("0, 0, 50"), [0, 0, 0])
Roundtimer(Vector(0, 0, 0), [0, 0, 0])
DoublePointsSpawner(Vector(0, 0, 0), [0, 0, 0])
DoublePointsDrop(Vector("0, 0, 24"), [0, 0, 0])
FireSaleSpawner(Vector(0, 0, 0), [0, 0, 0])
FireSaleDrop(Vector("0, 0, 24"), [0, 0, 0])
InstakillSpawner(Vector(0, 0, 0), [0, 0, 0])
InstakillDrop(Vector("0, 0, 24"), [0, 0, 0])
NukeSpawner(Vector(0, 0, 0), [0, 0, 0])
NukeDrop(Vector("0, 0, 24"), [0, 0, 0])
MaxAmmoSpawner(Vector(0, 0, 0), [0, 0, 0])
MaxAmmoDrop(Vector("0, 0, 24"), [0, 0, 0])
BonusPointsSpawner(Vector(0, 0, 0), [0, 0, 0])
BonusPointsDrop(Vector("0, 0, 24"), [0, 0, 0])
DumpsterSpawner(Vector(0, 0, 0), [0, 0, 0])
DumpsterBoxRewrite1(Vector("0, 0, 104"), ["90, 0, 180"])
DumpsterBoxRewrite2(Vector("0, 0, 104"), ["90, 0, 180"])
DumpsterBoxRewrite3(Vector("0, 0, 104"), ["90, 0, 180"])
DumpsterBoxRewrite4(Vector("0, 0, 104"), ["90, 0, 180"])
DumpsterBoxRewrite5(Vector("0, 0, 104"), ["90, 0, 180"])
DumpsterBox(Vector(0, 0, 0), [0, 0, 0])
Camera_Crew_Death(Vector("2948, 924, 518"), ["14, 206, 0"])
FrearmPT(Vector(0, 0, 0), [0, 0, 0])
ThundergunPT(Vector(0, 0, 0), [0, 0, 0])
Thundergun_2PT(Vector(0, 0, 0), [0, 0, 0])